...
import kotlinx.android.synthetic.main.activity_sound6.*

import java.util.*

class Sound6 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sound6)
...
/////////////////////
    ...
    inner class MyCounter(millisInFuture: Long, countDownInterval: Long) : CountDownTimer(millisInFuture, countDownInterval) {
        ...
        override fun onFinish() {
            ...
            var intent3: Intent = Intent(this@Sound6, sound7::class.java)
    ...
    private fun fetchImageGame() {
        ...
        var intent3: Intent = Intent(this, sound7::class.java)
