...
import kotlinx.android.synthetic.main.activity_sound3.*
import java.lang.reflect.InvocationTargetException
import java.util.*

class sound3 : AppCompatActivity() {
...
/////////////////////
    ...
    inner class MyCounter(millisInFuture: Long, countDownInterval: Long) : CountDownTimer(millisInFuture, countDownInterval) {
        ...
        override fun onFinish() {
            ...
            var intent3: Intent = Intent(this@sound3, Sound4::class.java)
    ...
    private fun fetchImageGame() {
        ...
        var intent3: Intent = Intent(this, Sound4::class.java)
