...
import kotlinx.android.synthetic.main.activity_sound8.*

import java.util.*

class Sound8 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sound8)
...
/////////////////////
    ...
    inner class MyCounter(millisInFuture: Long, countDownInterval: Long) : CountDownTimer(millisInFuture, countDownInterval) {
        ...
        override fun onFinish() {
            ...
            var intent3: Intent = Intent(this@Sound8, Sound9::class.java)
    ...
    private fun fetchImageGame() {
        ...
        var intent3: Intent = Intent(this, Sound9::class.java)
