...
import kotlinx.android.synthetic.main.activity_sound7.*
import java.util.*

class sound7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sound7)
...
/////////////////////
    ...
    inner class MyCounter(millisInFuture: Long, countDownInterval: Long) : CountDownTimer(millisInFuture, countDownInterval) {
        ...
        override fun onFinish() {
            ...
            var intent3: Intent = Intent(this@sound7, Sound8::class.java)
    ...
    private fun fetchImageGame() {
        ...
        var intent3: Intent = Intent(this, Sound8::class.java)
