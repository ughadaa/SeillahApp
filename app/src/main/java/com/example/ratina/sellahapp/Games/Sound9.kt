...
import kotlinx.android.synthetic.main.activity_sound9.*

import java.util.*

class Sound9 : AppCompatActivity() {
...
/////////////////////
    ...
    inner class MyCounter(millisInFuture: Long, countDownInterval: Long) : CountDownTimer(millisInFuture, countDownInterval) {
        ...
        override fun onFinish() {
            ...
            var intent3: Intent = Intent(this@Sound9, Sound10::class.java)
    ...
    private fun fetchImageGame() {
        ...
        var intent3: Intent = Intent(this, Sound10::class.java)
