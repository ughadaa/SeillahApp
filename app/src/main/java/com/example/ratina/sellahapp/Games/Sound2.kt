...
import kotlinx.android.synthetic.main.activity_sound2.*
import java.util.*

class Sound2 : AppCompatActivity() {
...
/////////////////////
    ...
    inner class MyCounter(millisInFuture: Long, countDownInterval: Long) : CountDownTimer(millisInFuture, countDownInterval) {
        ...
        override fun onFinish() {
            ...
            var intent3: Intent = Intent(this@Sound2, sound3::class.java)
    ...
    private fun fetchImageGame() {
        ...
        var intent3: Intent = Intent(this, sound3::class.java)
