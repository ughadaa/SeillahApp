...
import kotlinx.android.synthetic.main.activity_sound5.*

import java.util.*

class Sound5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sound5)
...
/////////////////////
    ...
    inner class MyCounter(millisInFuture: Long, countDownInterval: Long) : CountDownTimer(millisInFuture, countDownInterval) {
        ...
        override fun onFinish() {
            ...
            var intent3: Intent = Intent(this@Sound5, Sound6::class.java)
    ...
    private fun fetchImageGame() {
        ...
        var intent3: Intent = Intent(this, Sound6::class.java)
